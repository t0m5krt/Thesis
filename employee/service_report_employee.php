    ...
    <div class="service-report container">
        ...
        <form>
            <table class="table centered-table">
                ...
                <tbody>
                    <tr>
                        <td><input type="text" class="work_order_no"></td>
                        <td><input type="date" class="date"></td>
                        <td><input type="text" class="project_site"></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table centered-table">
                ...
                <tbody>
                    <tr>
                        <td><input type="text" class="machine_code_id"></td>
                        <td><input type="text" class="brand"></td>
                        <td><input type="text" class="model"></td>
                        <td><input type="text" class="serial_number"></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table centered-table">
                ...
                <tbody>
                    <tr>
                        <td><input type="text" class="smr_kmr"></td>
                        <td>
